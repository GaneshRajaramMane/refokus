    ...
    return(
        ...
        <div className="w-full   py-5 text-white ">
            <div className=" relative max-w-screen-xl mx-auto text-center ">
                <h1 className="select-none   font-medium leading-none text-[34vw]">work</h1>
                <div className="absolute top-0 w-full h-full ">
                    {images.map((img,i)=>(img.isActive && ( <img key={i} className="w-60 rounded-lg absolute  -translate-x-[50%] -translate-y-[50%]" style={{top:img.top,left:img.left}} src={img.url}></img>)))}
                </div>
            </div>
        </div>
        </>
